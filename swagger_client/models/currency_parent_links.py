...
class CurrencyParentLinks(object):
    """
    ...
    def __init__(self, _self=None):
        """
        CurrencyParentLinks - a model defined in Swagger
    ...
    def _self(self):
        """
        Gets the _self of this CurrencyParentLinks.

        :return: The _self of this CurrencyParentLinks.
        :rtype: str
        """
        return self.__self
    ...
    def _self(self, _self):
        """
        Sets the _self of this CurrencyParentLinks.

        :param _self: The _self of this CurrencyParentLinks.
        :type: str
        """
