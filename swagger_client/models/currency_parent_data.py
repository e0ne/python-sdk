...
class CurrencyParentData(object):
    """
    ...
    def __init__(self, type=None, id=None):
        """
        CurrencyParentData - a model defined in Swagger
    ...
    def type(self):
        """
        Gets the type of this CurrencyParentData.

        :return: The type of this CurrencyParentData.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this CurrencyParentData.

        :param type: The type of this CurrencyParentData.
        :type: str
        """
    ...
    def id(self):
        """
        Gets the id of this CurrencyParentData.
        Parent currency ID

        :return: The id of this CurrencyParentData.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this CurrencyParentData.
        Parent currency ID

        :param id: The id of this CurrencyParentData.
        :type: str
        """
