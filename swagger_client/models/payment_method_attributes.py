...
class PaymentMethodAttributes(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, name=None, alias=None, processor_name=None, category=None):
        """
        PaymentMethodAttributes - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this PaymentMethodAttributes.
        Payment-method`s name

        :return: The name of this PaymentMethodAttributes.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this PaymentMethodAttributes.
        Payment-method`s name

        :param name: The name of this PaymentMethodAttributes.
        :type: str
        """
    ...
    def alias(self):
        """
        Gets the alias of this PaymentMethodAttributes.
        Payment-method`s alias

        :return: The alias of this PaymentMethodAttributes.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this PaymentMethodAttributes.
        Payment-method`s alias

        :param alias: The alias of this PaymentMethodAttributes.
        :type: str
        """
    ...
    def processor_name(self):
        """
        Gets the processor_name of this PaymentMethodAttributes.
        Payment-method`s processor

        :return: The processor_name of this PaymentMethodAttributes.
        :rtype: str
        """
    ...
    def processor_name(self, processor_name):
        """
        Sets the processor_name of this PaymentMethodAttributes.
        Payment-method`s processor

        :param processor_name: The processor_name of this PaymentMethodAttributes.
        :type: str
        """
    ...
    def category(self):
        """
        Gets the category of this PaymentMethodAttributes.

        :return: The category of this PaymentMethodAttributes.
        :rtype: str
        """
    ...
    def category(self, category):
        """
        Sets the category of this PaymentMethodAttributes.

        :param category: The category of this PaymentMethodAttributes.
        :type: str
        """
