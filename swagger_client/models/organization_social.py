...
class OrganizationSocial(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, facebook=None, google_plus=None, linked_in=None, twitter=None, vkontakte=None):
        """
        OrganizationSocial - a model defined in Swagger
