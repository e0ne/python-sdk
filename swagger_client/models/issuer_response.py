...
class IssuerResponse(object):
    ...
    def __init__(self, data=None):
        """
        IssuerResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this IssuerResponse.

        :return: The data of this IssuerResponse.
        :rtype: Issuer
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this IssuerResponse.

        :param data: The data of this IssuerResponse.
        :type: Issuer
        """
