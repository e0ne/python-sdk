...
class IndustryResponse(object):
    ...
    def __init__(self, data=None):
        """
        IndustryResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this IndustryResponse.

        :return: The data of this IndustryResponse.
        :rtype: Industry
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this IndustryResponse.

        :param data: The data of this IndustryResponse.
        :type: Industry
        """
