...
class PaymentProviderAttributes(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, name=None, alias=None, types=None, features=None, sales_channels=None):
        """
        PaymentProviderAttributes - a model defined in Swagger
    ...
    def alias(self):
        """
        Gets the alias of this PaymentProviderAttributes.
        Payment-provider`s alias

        :return: The alias of this PaymentProviderAttributes.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this PaymentProviderAttributes.
        Payment-provider`s alias

        :param alias: The alias of this PaymentProviderAttributes.
        :type: str
        """
