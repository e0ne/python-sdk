...
class PaymentProcessorAttributes(object):
    """
    ...
    def __init__(self, name=None):
        """
        PaymentProcessorAttributes - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this PaymentProcessorAttributes.
        Payment-processor`s name

        :return: The name of this PaymentProcessorAttributes.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this PaymentProcessorAttributes.
        Payment-processor`s name

        :param name: The name of this PaymentProcessorAttributes.
        :type: str
        """
