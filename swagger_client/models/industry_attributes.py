...
class IndustryAttributes(object):
    """
    ...
    def __init__(self, name=None, alias=None):
        """
        IndustryAttributes - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this IndustryAttributes.
        Name

        :return: The name of this IndustryAttributes.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this IndustryAttributes.
        Name

        :param name: The name of this IndustryAttributes.
        :type: str
        """
    ...
    def alias(self):
        """
        Gets the alias of this IndustryAttributes.

        :return: The alias of this IndustryAttributes.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this IndustryAttributes.

        :param alias: The alias of this IndustryAttributes.
        :type: str
        """
