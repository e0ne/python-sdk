...
class ExchangerAttributes(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, organization=None, status=None, wmid=None, rates_export_url=None, rates_export_standard=None):
        """
        ExchangerAttributes - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'organization': 'ExchangerAttributesOrganization',
            'status': 'str',
            'wmid': 'int',
    ...
    def organization(self):
        """
        Gets the organization of this ExchangerAttributes.

        :return: The organization of this ExchangerAttributes.
        :rtype: ExchangerAttributesOrganization
        """
    ...
    def organization(self, organization):
        """
        Sets the organization of this ExchangerAttributes.

        :param organization: The organization of this ExchangerAttributes.
        :type: ExchangerAttributesOrganization
        """
    ...
    def status(self):
        ...
        Exchanger`s status [online, offline, blocked, deleted]
