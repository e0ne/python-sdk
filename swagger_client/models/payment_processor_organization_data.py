...
class PaymentProcessorOrganizationData(object):
    """
    ...
    def __init__(self, type=None, id=None):
        """
        PaymentProcessorOrganizationData - a model defined in Swagger
    ...
    def type(self):
        """
        Gets the type of this PaymentProcessorOrganizationData.

        :return: The type of this PaymentProcessorOrganizationData.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this PaymentProcessorOrganizationData.

        :param type: The type of this PaymentProcessorOrganizationData.
        :type: str
        """
    ...
    def id(self):
        """
        Gets the id of this PaymentProcessorOrganizationData.
        Organization`s ID

        :return: The id of this PaymentProcessorOrganizationData.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this PaymentProcessorOrganizationData.
        Organization`s ID

        :param id: The id of this PaymentProcessorOrganizationData.
        :type: str
        """
