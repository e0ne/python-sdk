...
class CountryAttributes(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, name=None, code_alpha3=None, capital=None, native_name=None, region=None, sub_region=None, area=None, population=None, top_level_domains=None, timezones=None, calling_codes=None, languages=None):
        """
        CountryAttributes - a model defined in Swagger
    ...
    def region(self):
        ...
        Country’s region:<br>      * Africa   * Americas   * Asia   * Europe   * Oceania   * Polar 
