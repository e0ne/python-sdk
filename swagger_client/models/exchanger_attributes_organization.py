...
class ExchangerAttributesOrganization(object):
    """
    ...
    def __init__(self, name=None):
        """
        ExchangerAttributesOrganization - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this ExchangerAttributesOrganization.
        Exchanger`s name

        :return: The name of this ExchangerAttributesOrganization.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ExchangerAttributesOrganization.
        Exchanger`s name

        :param name: The name of this ExchangerAttributesOrganization.
        :type: str
        """
