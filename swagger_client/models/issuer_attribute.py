...
class IssuerAttribute(object):
    ...
    def __init__(self, alias=None, name=None):
        """
        IssuerAttribute - a model defined in Swagger
    ...
    def alias(self):
        """
        Gets the alias of this IssuerAttribute.

        :return: The alias of this IssuerAttribute.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this IssuerAttribute.

        :param alias: The alias of this IssuerAttribute.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this IssuerAttribute.

        :return: The name of this IssuerAttribute.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this IssuerAttribute.

        :param name: The name of this IssuerAttribute.
        :type: str
        """
