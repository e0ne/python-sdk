...
class IssuerOrganization(object):
    ...
    def __init__(self, data=None, links=None):
        """
        IssuerOrganization - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'data': 'IssuerOrganizationData',
            'links': 'IssuerOrganizationLinks'
        }
    ...
    def data(self):
        """
        Gets the data of this IssuerOrganization.

        :return: The data of this IssuerOrganization.
        :rtype: IssuerOrganizationData
        """
        return self._data
    ...
    def data(self, data):
        """
        Sets the data of this IssuerOrganization.

        :param data: The data of this IssuerOrganization.
        :type: IssuerOrganizationData
        """
    ...
    def links(self):
        """
        Gets the links of this IssuerOrganization.

        :return: The links of this IssuerOrganization.
        :rtype: IssuerOrganizationLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this IssuerOrganization.

        :param links: The links of this IssuerOrganization.
        :type: IssuerOrganizationLinks
        """
