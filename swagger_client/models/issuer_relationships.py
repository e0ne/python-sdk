...
class IssuerRelationships(object):
    """
    ...
    def __init__(self, organization=None):
        """
        IssuerRelationships - a model defined in Swagger
    ...
    def organization(self):
        """
        Gets the organization of this IssuerRelationships.

        :return: The organization of this IssuerRelationships.
        :rtype: IssuerOrganization
        """
    ...
    def organization(self, organization):
        """
        Sets the organization of this IssuerRelationships.

        :param organization: The organization of this IssuerRelationships.
