...
class ExchangersApi(object):
    ...
    def exchangers_get(self, **kwargs):
        """
        List of exchangers
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.exchangers_get(callback=callback_function)
        ...
        :param list[str] sort: Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | status | -status | | wmid | -wmid | | rate_type | -rate_type | | rates_export_standard | <nobr>-rates_export_standard</nobr> | 
        :return: ExchangersResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.exchangers_get_with_http_info(**kwargs)
        else:
            (data) = self.exchangers_get_with_http_info(**kwargs)
            return data

    def exchangers_get_with_http_info(self, **kwargs):
        """
        List of exchangers
        Returns all available exchangers.<br> Rates export standards is represented by:  * [estandards](http://estandards.info) * [jsons](http://jsons.info) * ratex - our internal standard 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.exchangers_get_with_http_info(callback=callback_function)
        ...
        all_params = ['page_number', 'page_size', 'filter_name', 'filter_status', 'sort']
        ...
        resource_path = '/exchangers'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='ExchangersResponse',
    ...
    def exchangers_id_get(self, id, **kwargs):
        """
        Exchanger by ID
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.exchangers_id_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.exchangers_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.exchangers_id_get_with_http_info(id, **kwargs)
            return data

    def exchangers_id_get_with_http_info(self, id, **kwargs):
        """
        Exchanger by ID
        Returns exchanger with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.exchangers_id_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method exchangers_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ExchangerResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
