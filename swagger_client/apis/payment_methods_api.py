...
class PaymentMethodsApi(object):
    ...
    def payment_methods_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_methods_get(callback=callback_function)
        ...
        :param str filter_processor_name: Filtering by processor_name.
        :param list[str] filter_category: Filtering by category.
        :param list[str] sort: Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | alias | -alias | | processor_name | -processor_name | | category | -category | 
        ...
        if kwargs.get('callback'):
            return self.payment_methods_get_with_http_info(**kwargs)
        else:
            (data) = self.payment_methods_get_with_http_info(**kwargs)
            return data

    def payment_methods_get_with_http_info(self, **kwargs):
        """
        List of payment methods
        Returns all available payment methods. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_methods_get_with_http_info(callback=callback_function)
        ...
        all_params = ['page_number', 'page_size', 'filter_name', 'filter_alias', 'filter_processor_name', 'filter_category', 'sort']
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method payment_methods_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'filter_processor_name' in params:
            query_params['filter[processor_name]'] = params['filter_processor_name']
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='PaymentMethodsResponse',
    ...
    def payment_methods_id_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_methods_id_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.payment_methods_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.payment_methods_id_get_with_http_info(id, **kwargs)
            return data

    def payment_methods_id_get_with_http_info(self, id, **kwargs):
        """
        Payment method by ID
        Returns payment method with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_methods_id_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method payment_methods_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `payment_methods_id_get`")


        collection_formats = {}

        resource_path = '/payment-methods/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
