...
class IndustriesApi(object):
    ...
    def organization_industries_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.organization_industries_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.organization_industries_get_with_http_info(**kwargs)
        else:
            (data) = self.organization_industries_get_with_http_info(**kwargs)
            return data

    def organization_industries_get_with_http_info(self, **kwargs):
        """
        List of organization industries
        Returns all available organization industries. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.organization_industries_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method organization_industries_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/organization-industries'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='IndustriesResponse',
    ...
    def organization_industries_id_get(self, id, **kwargs):
        """
        Industry by ID
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.organization_industries_id_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.organization_industries_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.organization_industries_id_get_with_http_info(id, **kwargs)
            return data

    def organization_industries_id_get_with_http_info(self, id, **kwargs):
        """
        Industry by ID
        Returns industry with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.organization_industries_id_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method organization_industries_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `organization_industries_id_get`")


        collection_formats = {}

        resource_path = '/organization-industries/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='IndustryResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
