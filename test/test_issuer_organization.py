...
from openfintech_sdk.models.issuer_organization import IssuerOrganization


class TestIssuerOrganization(unittest.TestCase):
    """ IssuerOrganization unit test stubs """
    ...
    def testIssuerOrganization(self):
        """
        Test IssuerOrganization
        """
        model = openfintech_sdk.models.issuer_organization.IssuerOrganization()
