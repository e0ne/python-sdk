...
from openfintech_sdk.models.bank_organization_links import BankOrganizationLinks


class TestBankOrganizationLinks(unittest.TestCase):
    """ BankOrganizationLinks unit test stubs """
    ...
    def testBankOrganizationLinks(self):
        """
        Test BankOrganizationLinks
        """
        model = openfintech_sdk.models.bank_organization_links.BankOrganizationLinks()
