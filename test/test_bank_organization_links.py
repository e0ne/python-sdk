...
from swagger_client.models.bank_organization_links import BankOrganizationLinks
...
class TestBankOrganizationLinks(unittest.TestCase):
    ...
    def testBankOrganizationLinks(self):
        ...
        """
        model = swagger_client.models.bank_organization_links.BankOrganizationLinks()
