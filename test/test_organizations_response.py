...
from openfintech_sdk.models.organizations_response import OrganizationsResponse
...
class TestOrganizationsResponse(unittest.TestCase):
    ...
    def testOrganizationsResponse(self):
        ...
        """
        model = openfintech_sdk.models.organizations_response.OrganizationsResponse()
