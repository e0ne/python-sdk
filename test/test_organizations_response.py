...
from swagger_client.models.organizations_response import OrganizationsResponse
...
class TestOrganizationsResponse(unittest.TestCase):
    ...
    def testOrganizationsResponse(self):
        ...
        """
        model = swagger_client.models.organizations_response.OrganizationsResponse()
