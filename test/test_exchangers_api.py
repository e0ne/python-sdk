...
from openfintech_sdk.apis.exchangers_api import ExchangersApi


class TestExchangersApi(unittest.TestCase):
    """ ExchangersApi unit test stubs """

    def setUp(self):
        self.api = openfintech_sdk.apis.exchangers_api.ExchangersApi()

    def tearDown(self):
        pass

    def test_exchangers_get(self):
        """
    ...
    def test_exchangers_id_get(self):
        """
