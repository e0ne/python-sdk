...
from swagger_client.models.payment_processor_relationships import PaymentProcessorRelationships
...
class TestPaymentProcessorRelationships(unittest.TestCase):
    ...
    def testPaymentProcessorRelationships(self):
        ...
        """
        model = swagger_client.models.payment_processor_relationships.PaymentProcessorRelationships()
