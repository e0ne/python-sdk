...
from openfintech_sdk.models.payment_processor_relationships import PaymentProcessorRelationships


class TestPaymentProcessorRelationships(unittest.TestCase):
    """ PaymentProcessorRelationships unit test stubs """
    ...
    def testPaymentProcessorRelationships(self):
        """
        Test PaymentProcessorRelationships
        """
        model = openfintech_sdk.models.payment_processor_relationships.PaymentProcessorRelationships()
