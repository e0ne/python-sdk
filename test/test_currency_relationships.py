...
from swagger_client.models.currency_relationships import CurrencyRelationships
...
class TestCurrencyRelationships(unittest.TestCase):
    ...
    def testCurrencyRelationships(self):
        ...
        """
        model = swagger_client.models.currency_relationships.CurrencyRelationships()
