...
from openfintech_sdk.models.currency_relationships import CurrencyRelationships


class TestCurrencyRelationships(unittest.TestCase):
    """ CurrencyRelationships unit test stubs """
    ...
    def testCurrencyRelationships(self):
        """
        Test CurrencyRelationships
        """
        model = openfintech_sdk.models.currency_relationships.CurrencyRelationships()
