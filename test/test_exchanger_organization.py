...
from openfintech_sdk.models.exchanger_organization import ExchangerOrganization


class TestExchangerOrganization(unittest.TestCase):
    """ ExchangerOrganization unit test stubs """
    ...
    def testExchangerOrganization(self):
        """
        Test ExchangerOrganization
        """
        model = openfintech_sdk.models.exchanger_organization.ExchangerOrganization()
