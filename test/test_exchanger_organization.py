...
from swagger_client.models.exchanger_organization import ExchangerOrganization
...
class TestExchangerOrganization(unittest.TestCase):
    ...
    def testExchangerOrganization(self):
        ...
        """
        model = swagger_client.models.exchanger_organization.ExchangerOrganization()
