...
from swagger_client.models.organization_attributes import OrganizationAttributes
...
class TestOrganizationAttributes(unittest.TestCase):
    ...
    def testOrganizationAttributes(self):
        ...
        """
        model = swagger_client.models.organization_attributes.OrganizationAttributes()
