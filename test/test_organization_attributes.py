...
from openfintech_sdk.models.organization_attributes import OrganizationAttributes
...
class TestOrganizationAttributes(unittest.TestCase):
    ...
    def testOrganizationAttributes(self):
        ...
        """
        model = openfintech_sdk.models.organization_attributes.OrganizationAttributes()
