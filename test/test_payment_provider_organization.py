...
from openfintech_sdk.models.payment_provider_organization import PaymentProviderOrganization


class TestPaymentProviderOrganization(unittest.TestCase):
    """ PaymentProviderOrganization unit test stubs """
    ...
    def testPaymentProviderOrganization(self):
        """
        Test PaymentProviderOrganization
        """
        model = openfintech_sdk.models.payment_provider_organization.PaymentProviderOrganization()
