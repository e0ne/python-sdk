...
from swagger_client.models.payment_provider_organization import PaymentProviderOrganization
...
class TestPaymentProviderOrganization(unittest.TestCase):
    ...
    def testPaymentProviderOrganization(self):
        ...
        """
        model = swagger_client.models.payment_provider_organization.PaymentProviderOrganization()
