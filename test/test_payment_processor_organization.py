...
from swagger_client.models.payment_processor_organization import PaymentProcessorOrganization
...
class TestPaymentProcessorOrganization(unittest.TestCase):
    ...
    def testPaymentProcessorOrganization(self):
        ...
        """
        model = swagger_client.models.payment_processor_organization.PaymentProcessorOrganization()
