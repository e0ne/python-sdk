...
from openfintech_sdk.models.payment_processor_organization import PaymentProcessorOrganization


class TestPaymentProcessorOrganization(unittest.TestCase):
    """ PaymentProcessorOrganization unit test stubs """
    ...
    def testPaymentProcessorOrganization(self):
        """
        Test PaymentProcessorOrganization
        """
        model = openfintech_sdk.models.payment_processor_organization.PaymentProcessorOrganization()
