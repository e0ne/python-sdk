...
from openfintech_sdk.models.payment_method_attributes import PaymentMethodAttributes


class TestPaymentMethodAttributes(unittest.TestCase):
    """ PaymentMethodAttributes unit test stubs """
    ...
    def testPaymentMethodAttributes(self):
        """
        Test PaymentMethodAttributes
        """
        model = openfintech_sdk.models.payment_method_attributes.PaymentMethodAttributes()
