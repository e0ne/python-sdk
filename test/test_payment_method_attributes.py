...
from swagger_client.models.payment_method_attributes import PaymentMethodAttributes
...
class TestPaymentMethodAttributes(unittest.TestCase):
    ...
    def testPaymentMethodAttributes(self):
        ...
        """
        model = swagger_client.models.payment_method_attributes.PaymentMethodAttributes()
