...
from openfintech_sdk.models.country_attributes import CountryAttributes


class TestCountryAttributes(unittest.TestCase):
    """ CountryAttributes unit test stubs """
    ...
    def testCountryAttributes(self):
        """
        Test CountryAttributes
        """
        model = openfintech_sdk.models.country_attributes.CountryAttributes()
