...
from swagger_client.models.payment_providers_response import PaymentProvidersResponse
...
class TestPaymentProvidersResponse(unittest.TestCase):
    ...
    def testPaymentProvidersResponse(self):
        ...
        """
        model = swagger_client.models.payment_providers_response.PaymentProvidersResponse()
