...
from openfintech_sdk.models.payment_providers_response import PaymentProvidersResponse


class TestPaymentProvidersResponse(unittest.TestCase):
    """ PaymentProvidersResponse unit test stubs """
    ...
    def testPaymentProvidersResponse(self):
        """
        Test PaymentProvidersResponse
        """
        model = openfintech_sdk.models.payment_providers_response.PaymentProvidersResponse()
