...
from openfintech_sdk.models.bank_organization_data import BankOrganizationData


class TestBankOrganizationData(unittest.TestCase):
    """ BankOrganizationData unit test stubs """
    ...
    def testBankOrganizationData(self):
        """
        Test BankOrganizationData
        """
        model = openfintech_sdk.models.bank_organization_data.BankOrganizationData()
