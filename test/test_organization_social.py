...
from openfintech_sdk.models.organization_social import OrganizationSocial


class TestOrganizationSocial(unittest.TestCase):
    """ OrganizationSocial unit test stubs """
    ...
    def testOrganizationSocial(self):
        """
        Test OrganizationSocial
        """
        model = openfintech_sdk.models.organization_social.OrganizationSocial()
