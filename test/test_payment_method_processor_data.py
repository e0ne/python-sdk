...
from openfintech_sdk.models.payment_method_processor_data import PaymentMethodProcessorData


class TestPaymentMethodProcessorData(unittest.TestCase):
    """ PaymentMethodProcessorData unit test stubs """
    ...
    def testPaymentMethodProcessorData(self):
        """
        Test PaymentMethodProcessorData
        """
        model = openfintech_sdk.models.payment_method_processor_data.PaymentMethodProcessorData()
