...
from swagger_client.models.payment_method_processor_data import PaymentMethodProcessorData
...
class TestPaymentMethodProcessorData(unittest.TestCase):
    ...
    def testPaymentMethodProcessorData(self):
        ...
        """
        model = swagger_client.models.payment_method_processor_data.PaymentMethodProcessorData()
