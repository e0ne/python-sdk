...
from openfintech_sdk.models.organization_hq import OrganizationHq


class TestOrganizationHq(unittest.TestCase):
    """ OrganizationHq unit test stubs """
    ...
    def testOrganizationHq(self):
        """
        Test OrganizationHq
        """
        model = openfintech_sdk.models.organization_hq.OrganizationHq()
