...
from openfintech_sdk.apis.industries_api import IndustriesApi
...
class TestIndustriesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openfintech_sdk.apis.industries_api.IndustriesApi()

    def tearDown(self):
        pass

    def test_organization_industries_get(self):
        """
        Test case for organization_industries_get

        List of organization industries
        """
        pass

    def test_organization_industries_id_get(self):
        """
        Test case for organization_industries_id_get
