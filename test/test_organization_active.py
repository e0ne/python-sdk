...
from openfintech_sdk.models.organization_active import OrganizationActive


class TestOrganizationActive(unittest.TestCase):
    """ OrganizationActive unit test stubs """
    ...
    def testOrganizationActive(self):
        """
        Test OrganizationActive
        """
        model = openfintech_sdk.models.organization_active.OrganizationActive()
