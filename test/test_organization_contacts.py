...
from openfintech_sdk.models.organization_contacts import OrganizationContacts


class TestOrganizationContacts(unittest.TestCase):
    """ OrganizationContacts unit test stubs """
    ...
    def testOrganizationContacts(self):
        """
        Test OrganizationContacts
        """
        model = openfintech_sdk.models.organization_contacts.OrganizationContacts()
