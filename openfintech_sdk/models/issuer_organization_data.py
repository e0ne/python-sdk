...
class IssuerOrganizationData(object):
    """
    ...
    def __init__(self, type=None, id=None):
        """
        IssuerOrganizationData - a model defined in Swagger
    ...
    def type(self):
        """
        Gets the type of this IssuerOrganizationData.

        :return: The type of this IssuerOrganizationData.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this IssuerOrganizationData.

        :param type: The type of this IssuerOrganizationData.
        :type: str
        """
    ...
    def id(self):
        """
        Gets the id of this IssuerOrganizationData.
        Organization`s ID

        :return: The id of this IssuerOrganizationData.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this IssuerOrganizationData.
        Organization`s ID

        :param id: The id of this IssuerOrganizationData.
        :type: str
        """
