...
class PaymentProcessorResponse(object):
    """
    ...
    def __init__(self, data=None):
        """
        PaymentProcessorResponse - a model defined in Swagger
    ...
    def data(self):
        """
        Gets the data of this PaymentProcessorResponse.

        :return: The data of this PaymentProcessorResponse.
    ...
    def data(self, data):
        """
        Sets the data of this PaymentProcessorResponse.

        :param data: The data of this PaymentProcessorResponse.
