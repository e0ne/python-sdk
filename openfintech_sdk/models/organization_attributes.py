...
class OrganizationAttributes(object):
    ...
    """
    def __init__(self, name=None, alias=None, description=None, site=None, wiki=None, blog=None, contacts=None, status=None, address=None, social_profile=None, industries=None, icon=None):
        """
        OrganizationAttributes - a model defined in Swagger
        ...
        self.swagger_types = {
            ...
            'social_profile': 'OrganizationSocial',
            'industries': 'list[str]',
            'icon': 'str'
        }
    ...
    def alias(self):
        """
        Gets the alias of this OrganizationAttributes.
        Organization`s alias

        :return: The alias of this OrganizationAttributes.
        :rtype: str
        """
        return self._alias
    ...
    def alias(self, alias):
        """
        Sets the alias of this OrganizationAttributes.
        Organization`s alias

        :param alias: The alias of this OrganizationAttributes.
        :type: str
        """
    ...
    def social_profile(self):
        """
        Gets the social_profile of this OrganizationAttributes.

        :return: The social_profile of this OrganizationAttributes.
    ...
    def social_profile(self, social_profile):
        """
        Sets the social_profile of this OrganizationAttributes.

        :param social_profile: The social_profile of this OrganizationAttributes.
