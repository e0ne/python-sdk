...
class MerchantIndustriesApi(object):
    """
    ...
    def merchant_industries_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.merchant_industries_get(callback=callback_function)
        ...
        :return: MerchantIndustriesResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.merchant_industries_get_with_http_info(**kwargs)
        else:
            (data) = self.merchant_industries_get_with_http_info(**kwargs)
            return data

    def merchant_industries_get_with_http_info(self, **kwargs):
        """
        List of merchant industries
        Returns all available merchant industries. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.merchant_industries_get_with_http_info(callback=callback_function)
        ...
        all_params = ['page_number', 'page_size', 'filter_name']
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method merchant_industries_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/merchant-industries'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='MerchantIndustriesResponse',
    ...
    def merchant_industries_id_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.merchant_industries_id_get(id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: Unique ID. (required)
        :return: MerchantIndustryResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.merchant_industries_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.merchant_industries_id_get_with_http_info(id, **kwargs)
            return data

    def merchant_industries_id_get_with_http_info(self, id, **kwargs):
        """
        Merchant industry by ID
        Returns merchant industry with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.merchant_industries_id_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method merchant_industries_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `merchant_industries_id_get`")


        collection_formats = {}

        resource_path = '/merchant-industries/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='MerchantIndustryResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
