...
class CountriesApi(object):
    ...
    def countries_get(self, **kwargs):
        ...
        :param list[str] filter_region: Filtration by region.
        :param list[str] filter_sub_region: Filtration by sub region.
        :param list[str] sort: Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | area | -area | | population | -population | | region | -region | | sub_region | -sub_region | 
    ...
    def countries_get_with_http_info(self, **kwargs):
        ...
        all_params = ['page_number', 'page_size', 'filter_region', 'filter_sub_region', 'sort']
        ...
        if 'filter_region' in params:
            query_params['filter[region]'] = params['filter_region']
            collection_formats['filter[region]'] = 'csv'
        if 'filter_sub_region' in params:
            query_params['filter[sub_region]'] = params['filter_sub_region']
            collection_formats['filter[sub_region]'] = 'csv'
        if 'sort' in params:
    ...
    def countries_id_get(self, id, **kwargs):
        """
        Country by ID
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.countries_id_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.countries_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.countries_id_get_with_http_info(id, **kwargs)
            return data

    def countries_id_get_with_http_info(self, id, **kwargs):
        """
        Country by ID
        Returns country with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.countries_id_get_with_http_info(id, callback=callback_function)
        ...
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `countries_id_get`")


        collection_formats = {}

        resource_path = '/countries/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
