...
class PaymentProvidersApi(object):
    """
    ...
    def payment_providers_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_providers_get(callback=callback_function)
        ...
        :param list[str] filter_types: Filtering by types.
        :param list[str] filter_sales_channels: Filtering by sales channels.
        :param list[str] filter_features: Filtering by features.
        :param list[str] sort: Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | alias | -alias | 
        ...
        if kwargs.get('callback'):
            return self.payment_providers_get_with_http_info(**kwargs)
        else:
            (data) = self.payment_providers_get_with_http_info(**kwargs)
            return data

    def payment_providers_get_with_http_info(self, **kwargs):
        """
        List of payment providers
        Returns all available payment providers. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_providers_get_with_http_info(callback=callback_function)
        ...
        all_params = ['page_number', 'page_size', 'filter_name', 'filter_alias', 'filter_types', 'filter_sales_channels', 'filter_features', 'sort']
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method payment_providers_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/payment-providers'.replace('{format}', 'json')
        path_params = {}
        ...
        if 'filter_types' in params:
            query_params['filter[types]'] = params['filter_types']
            collection_formats['filter[types]'] = 'csv'
        if 'filter_sales_channels' in params:
            query_params['filter[sales_channels]'] = params['filter_sales_channels']
            collection_formats['filter[sales_channels]'] = 'csv'
        if 'filter_features' in params:
            query_params['filter[features]'] = params['filter_features']
            collection_formats['filter[features]'] = 'csv'
        if 'sort' in params:
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='PaymentProvidersResponse',
    ...
    def payment_providers_id_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_providers_id_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.payment_providers_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.payment_providers_id_get_with_http_info(id, **kwargs)
            return data

    def payment_providers_id_get_with_http_info(self, id, **kwargs):
        """
        Payment provider by ID
        Returns payment provider with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_providers_id_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method payment_providers_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `payment_providers_id_get`")


        collection_formats = {}

        resource_path = '/payment-providers/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PaymentProviderResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
