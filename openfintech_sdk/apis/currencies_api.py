...
class CurrenciesApi(object):
    ...
    def currencies_get(self, **kwargs):
        """
        List of currencies
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.currencies_get(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int page_number: Current page number.
        :param int page_size: Page size.<br>*Default value: 100* 
        :param str filter_code_iso_alpha3: Filtering by ISO code.
        :param int filter_code_iso_numeric3: Filtering by ISO number.
        :param str filter_code_estandards_alpha: Filtering by estandards code.
        :param list[str] filter_currency_type: Filtration by currency type.
        :param list[str] filter_category: Filtration by category.
        :param list[str] sort: Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | type | -type | | category | -category | | code | -code | | code_iso_alpha3 | -code_iso_alpha3 | | code_iso_numeric3 | -code_iso_numeric3 | | code_estandards_alpha | -code_estandards_alpha | 
        ...
        if kwargs.get('callback'):
            return self.currencies_get_with_http_info(**kwargs)
        else:
            (data) = self.currencies_get_with_http_info(**kwargs)
            return data

    def currencies_get_with_http_info(self, **kwargs):
        """
        List of currencies
        Returns all available currencies. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.currencies_get_with_http_info(callback=callback_function)
        ...
        all_params = ['page_number', 'page_size', 'filter_code_iso_alpha3', 'filter_code_iso_numeric3', 'filter_code_estandards_alpha', 'filter_currency_type', 'filter_category', 'sort']
        ...
        if 'filter_code_iso_alpha3' in params:
            query_params['filter[code_iso_alpha3]'] = params['filter_code_iso_alpha3']
        if 'filter_code_iso_numeric3' in params:
            query_params['filter[code_iso_numeric3]'] = params['filter_code_iso_numeric3']
        if 'filter_code_estandards_alpha' in params:
            query_params['filter[code_estandards_alpha]'] = params['filter_code_estandards_alpha']
        if 'filter_currency_type' in params:
            query_params['filter[currency_type]'] = params['filter_currency_type']
            collection_formats['filter[currency_type]'] = 'csv'
        if 'filter_category' in params:
            query_params['filter[category]'] = params['filter_category']
            collection_formats['filter[category]'] = 'csv'
        if 'sort' in params:
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='CurrenciesResponse',
    ...
    def currencies_id_get(self, id, **kwargs):
        """
        Currency by ID
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.currencies_id_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.currencies_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.currencies_id_get_with_http_info(id, **kwargs)
            return data

    def currencies_id_get_with_http_info(self, id, **kwargs):
        """
        Currency by ID
        Returns currency with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.currencies_id_get_with_http_info(id, callback=callback_function)
        ...
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `currencies_id_get`")


        collection_formats = {}

        resource_path = '/currencies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
