...
class PaymentProcessorsApi(object):
    """
    ...
    def payment_processors_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_processors_get(callback=callback_function)
        ...
        :return: PaymentProcessorsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.payment_processors_get_with_http_info(**kwargs)
        else:
            (data) = self.payment_processors_get_with_http_info(**kwargs)
            return data

    def payment_processors_get_with_http_info(self, **kwargs):
        """
        List of payment processors
        Returns all available payment processors. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_processors_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method payment_processors_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/payment-processors'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='PaymentProcessorsResponse',
    ...
    def payment_processors_id_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_processors_id_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.payment_processors_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.payment_processors_id_get_with_http_info(id, **kwargs)
            return data

    def payment_processors_id_get_with_http_info(self, id, **kwargs):
        """
        Payment processor by ID
        Returns payment processor with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.payment_processors_id_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method payment_processors_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `payment_processors_id_get`")


        collection_formats = {}

        resource_path = '/payment-processors/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PaymentProcessorResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
