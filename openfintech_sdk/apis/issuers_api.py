...
class IssuersApi(object):
    ...
    def currency_issuers_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.currency_issuers_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.currency_issuers_get_with_http_info(**kwargs)
        else:
            (data) = self.currency_issuers_get_with_http_info(**kwargs)
            return data

    def currency_issuers_get_with_http_info(self, **kwargs):
        """
        List of currency issuers
        Returns all available currency issuers. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.currency_issuers_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method currency_issuers_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/currency-issuers'.replace('{format}', 'json')
        path_params = {}
    ...
    def currency_issuers_id_get(self, id, **kwargs):
        """
        Issuer by ID
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.currency_issuers_id_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.currency_issuers_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.currency_issuers_id_get_with_http_info(id, **kwargs)
            return data

    def currency_issuers_id_get_with_http_info(self, id, **kwargs):
        """
        Issuer by ID
        Returns issuer with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.currency_issuers_id_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method currency_issuers_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `currency_issuers_id_get`")


        collection_formats = {}

        resource_path = '/currency-issuers/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
