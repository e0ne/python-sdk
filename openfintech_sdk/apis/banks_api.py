...
class BanksApi(object):
    ...
    def banks_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.banks_get(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int page_number: Current page number.
        :param int page_size: Page size.<br>*Default value: 100* 
        :param str filter_sort_code: Filtering by banks code.
        :param str filter_alias: Filtering by alias.
        :param list[str] filter_status: Filtration by status.
        :param list[str] sort: Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | alias | -alias | | status | -status | | sort_code | -sort_code | 
        ...
        if kwargs.get('callback'):
            return self.banks_get_with_http_info(**kwargs)
        else:
            (data) = self.banks_get_with_http_info(**kwargs)
            return data

    def banks_get_with_http_info(self, **kwargs):
        """
        List of banks
        Returns all available banks 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.banks_get_with_http_info(callback=callback_function)
        ...
        all_params = ['page_number', 'page_size', 'filter_sort_code', 'filter_alias', 'filter_status', 'sort']
        ...
        resource_path = '/banks'.replace('{format}', 'json')
        path_params = {}
        ...
        if 'filter_sort_code' in params:
            query_params['filter[sort_code]'] = params['filter_sort_code']
    ...
    def banks_id_get(self, id, **kwargs):
        """
        Bank by ID
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.banks_id_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.banks_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.banks_id_get_with_http_info(id, **kwargs)
            return data

    def banks_id_get_with_http_info(self, id, **kwargs):
        """
        Bank by ID
        Returns bank with specific ID. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.banks_id_get_with_http_info(id, callback=callback_function)
